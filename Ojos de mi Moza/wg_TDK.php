...
$fb_cover_photo = '<div style="max-height:500px; overflow:hidden;"><img class="rsImg" src="'.$cover_image.'" alt="'.$company_name.'" /></div>';
...
$fb_widget = array(
	...
	'cover_photo'			=> '<div style="width:100%; height:600px; background:url('.$cover_image.'); background-position:center top; background-size: cover; overflow:hidden; margin: 0 auto 0 auto; zoom:1; background-position:0% '.$cover_image_offset.'%; -ms-background-position-x: center; -ms-background-position-y: '.$cover_image_offset.'%;"></div>',
