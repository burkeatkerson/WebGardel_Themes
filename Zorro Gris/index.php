...
<style>
#header, #mainNav ul ul { background:#<? echo $accent_color; ?>;!important}
a { color: #<? echo $accent_color; ?>;} <? //import the accent color preference here ?>
</style>

</head>

<body class="wide" style="background:url(assets/images/bg_<? echo $color_scheme; ?>.png)">
...
<?php if( $site->section('about_us') ){ //begin NOSOTROS section?><a id="nosotros"></a><br>
	<div class="full homeSection clearfix"><br>
		<div id="page" class="homeSection clearfix">
			<div class="prof_pic" style=" padding-top:50px; padding-bottom:50px;" align="center">
            	<? echo $fb_widget['prof_pic_custom']; ?>
           </div><p><? echo $description; ?></p>
           


        <div id="container-sub"  style="margin: 40px 0 70px; 0 ;">
	           <div align="center">
               	<ul id="fb_buttons_box">
						<li><? echo $fb_widget['likebutton']; ?>
                      </li>
						<li><? echo $fb_widget['followbutton']; ?>
                      </li>
                  </ul>   
               </div>
         </div>
...
<h2 class="sectionHead"><span>Comentarios</span></h2>
	<div style="margin:0 0 150px 0;"><? echo $fb_widget['comments']; ?></div>
...
<div class="two_third last">
	<div id="container-sub">
		<h3>Dirección</h3>
		<p style="font-size:80%;"><strong><? echo $company_name; ?></strong>
			<br><?= $site->data('address') ?>
			<br><?= $site->data('address2') ?></p>
            <p><a href="http://<? echo $company_name; ?>"><?= $site->data('domain_name') ?></a></p>
...
<div align="center">
<h2 class="sectionHead" style="padding-top:100px;"><span>Contacto</span></h2>
...
<?php } //end contacto section?>
	...
	<div id="footer" style="margin:150px 0 -30 0;">
