...
// variables
	...
	$company_name = $site->data('company_name');
	$description = $site->content('long_description');

// facebook 
	
$albumid = '281475991951856'; //if want a specific album
$contents = file_get_contents('http://graph.facebook.com/'.$fb_id.'/photos/uploaded?limit=8');
$photos = json_decode($contents,true);
$photos = $photos['data'];

$get_fb_photo_cover = file_get_contents('https://graph.facebook.com/'.$fb_id.'?fields=cover');
...
$fb_widget = array(
	...
	'likebox' 				=>	'<div class="fb-like-box" data-href="http://www.facebook.com/'.$fb_id.'" data-width="200" data-height="300" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>',
	'likebox_tall' 			=>	'<div class="fb-like-box" data-href="http://www.facebook.com/'.$fb_id.'" data-width="200" data-height="650" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>',
